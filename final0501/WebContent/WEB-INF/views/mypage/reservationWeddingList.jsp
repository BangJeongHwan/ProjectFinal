...
function checkResrve(rvseq) {
	if(confirm("예약 승인하시겠습니까?")){
		location.href = "WeddingReserveAdmit.do?rvseq="+rvseq;
	}
}
function rejectionResrve(rvseq) {
	if(confirm("예약 거절하시겠습니까?")){
		location.href = "WeddingReserveReject.do?rvseq="+rvseq;
	}
}
function goPage(pageNumber) {
	//alert("goPage");
	$("#_pageNumber").val(pageNumber);
	$("#_frmFormSearch").attr("target","_self").attr("action","reservationWhList.do").submit();
}
</script>
